...
class Profile(models.Model):
    ...
    # if in author related_name = 'posts' so we can use posts.all but if there is just class Post or Like we have to use
    # liek_set.all()
...
class RelalationshipManager(models.Manager):
    def invatations_received(self, reveiver):
